...
def pre_execution_gate(root: Path) -> dict[str, Any]:
    ...
    accepted_baseline = (baseline["object_count"] == BASELINE_COUNT and baseline["repository_fingerprint"] == BASELINE_FP) or campaign42_published or post_campaign43 or post_portfolio_pilot
    add("repository_baseline_count", accepted_baseline, actual=baseline["object_count"], expected=[BASELINE_COUNT, CAMPAIGN42_PUBLISHED_COUNT, POST_CAMPAIGN43_COUNT, POST_EVIDENCE_PORTFOLIO_PILOT_COUNT], idempotent_published_baseline=campaign42_published, post_campaign43_baseline=post_campaign43, post_portfolio_pilot_baseline=post_portfolio_pilot)
    add("repository_baseline_fingerprint", accepted_baseline, actual=baseline["repository_fingerprint"], expected=[BASELINE_FP, CAMPAIGN42_PUBLISHED_FP, POST_CAMPAIGN43_FP, POST_EVIDENCE_PORTFOLIO_PILOT_FP], idempotent_published_baseline=campaign42_published, post_campaign43_baseline=post_campaign43, post_portfolio_pilot_baseline=post_portfolio_pilot)
