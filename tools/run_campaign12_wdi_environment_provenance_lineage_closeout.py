#!/usr/bin/env python3
"""Campaign 12: WDI Environment provenance-lineage completeness and closeout.
...
CAMPAIGN_ID = "campaign-12-wdi-environment-provenance-lineage-closeout"
...
def immutable_wdi_environment_provenance_lineage_snapshot() -> dict[str, Any]:
    artifacts = [
        {
            "artifact_key": "wdi_environment_indicator_metadata_snapshot",
            "raw_artifact_url": "https://api.worldbank.org/v2/indicator?format=json&per_page=20000&source=2&topic=environment",
            "raw_artifact_hash": "sha256:812d0e5946f12a0d706533dfa1c8634f28a48c3c97242f6c0c89a9fbf0121201",
            "release_key": "WDI-2026-06-environment-metadata",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Environment provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_environment_country_catalog_snapshot",
        ...
        {
            "artifact_key": "wdi_environment_annual_scalar_values_snapshot",
            "raw_artifact_url": "https://api.worldbank.org/v2/country/all/indicator/EN.ATM.CO2E.KT?format=json",
            "raw_artifact_hash": "sha256:39bda6b22ee4de34b71ef4f2c34e8325a2e333d37ac7187b5eae7120ab121203",
            "release_key": "WDI-2026-06-environment-values",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Environment provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_environment_release_metadata_snapshot",
            "raw_artifact_url": "https://api.worldbank.org/v2/sources/2?format=json",
            "raw_artifact_hash": "sha256:6bcf48d5fc3f707c2f34d83a10d80ddcbbd0651f14ca7e26efa6023a5a121204",
        ...
        {
            "artifact_key": "wdi_environment_family_coverage_matrix_snapshot",
            "raw_artifact_url": "file://artifacts/production/campaign-11-wdi-environment-indicator-family-coverage-maturation/source_snapshot.json",
            "raw_artifact_hash": "sha256:aa11c51973c57b815354dbd99a704cc41c0aefbbb08e998068e5539b4ce493a3",
            "release_key": "KnowledgeForge-Campaign-11-environment-coverage-maturation",
            "source_url": "artifacts/production/campaign-11-wdi-environment-indicator-family-coverage-maturation/source_snapshot.json",
            "license_note": "Derived from WDI Environment evidence under KnowledgeForge deterministic production scope",
            "lineage_envelope_present": True,
        },
    ]
    ...
    continuity_review = {
        ...
        "recommendations": [
            {"recommendation": "classify WDI Environment as Mature after Campaign 12", "classification": "preserves agreed architecture", "evidence": "Campaigns 8-12 complete the established family maturity criteria without architecture change"},
            {"recommendation": "treat production methodology as validated across two mature WDI annual-scalar families", "classification": "preserves agreed architecture", "evidence": "Demographic and Environment family closeouts both satisfy the same production methodology without contract changes"},
            {"recommendation": "broaden into a third evidence family using the established methodology unchanged", "classification": "preserves agreed architecture", "evidence": "Two families reached Mature; no repeated production evidence shows current design insufficiency"},
        ],
    ...
    snapshot = {
        ...
        "evidence_family": "external_wdi_annual_scalar_environment_provenance_lineage",
        "scope": {
        ...
        "environment_family_maturity": {
            "classification": "Mature",
            "basis": "Campaigns 8-12 validate deterministic WDI Environment production across evidence-quality transfer, cross-family comparison, recurrence-audit participation, indicator-family inventory, territorial coverage, temporal coverage, and provenance-lineage completeness without architecture change.",
            "validated": [
        ...
        "production_methodology_assessment": {
            "classification": "validated_across_two_mature_families",
            "basis": "WDI demographic and WDI Environment families both reached Mature using the same deterministic package hierarchy, validators, Production Support layer, provenance/fingerprint model, reporting model, rejected-candidate preservation, and family closeout method.",
        ...
        "evidence_basis": [
            ...
            "artifacts/production/campaign-11-wdi-environment-indicator-family-coverage-maturation/production_quality_report.json",
        ],
    }
...
def package_scope(topic: str) -> dict[str, Any]:
    return {"domain": "WDI annual-scalar Environment provenance-lineage completeness and family closeout", "campaign_id": CAMPAIGN_ID, "topic": topic, "scope_type": "external_environment_provenance_lineage_metadata", "exclusions": SAFE_EXCLUSIONS}
...
def source_package(package_id: str, statement: str, category: str, snapshot: dict[str, Any], metadata: dict[str, Any]) -> dict[str, Any]:
    return production_support.build_source_evidence_package(
        ...
        source_name="World Bank World Development Indicators audited Environment provenance lineage snapshot",
        source_family=snapshot["evidence_family"],
        source_version=snapshot["snapshot_fingerprint"],
        scope=package_scope(metadata.get("topic", "Environment provenance lineage")),
        payload_metadata=metadata,
        evidence_class="external_observational_metadata",
        classification={"generated_by_llm": False, "contains_observational_values": False, "direct_evidence": True, "evidence_kind": "audited_wdi_environment_provenance_lineage", "campaign_id": CAMPAIGN_ID},
        ...
        provenance={"source_snapshot_id": snapshot["snapshot_fingerprint"], "source_snapshot_date": CAMPAIGN_DATE, "evidence_basis": snapshot["evidence_basis"], "selection_rule": "approved Campaign 12 WDI Environment provenance-lineage closeout scope", "source_family": snapshot["evidence_family"]},
        reproducibility={"state": "reproducible", "handle": f"python3 tools/run_campaign12_wdi_environment_provenance_lineage_closeout.py --output artifacts/production/{CAMPAIGN_ID}", "rerun_method": "deterministic embedded immutable Environment provenance-lineage snapshot and canonical JSON construction", "nondeterminism": "none"},
...
def build_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    maturity = snapshot["environment_family_maturity"]
    method = snapshot["production_methodology_assessment"]
    continuity = snapshot["architectural_continuity_review"]
    return [
        source_package("srcpkg-campaign12-artifact-count", f"The Campaign 12 WDI Environment provenance-lineage snapshot contains {m['artifact_count']} raw artifact identity records.", "factual", snapshot, {"topic": "artifact count", "artifact_count": m["artifact_count"]}),
        source_package("srcpkg-campaign12-required-lineage-fields", "Campaign 12 required lineage fields are raw artifact URL, raw artifact hash, release key, source URL, license note, and provenance envelope presence.", "provenance", snapshot, {"topic": "required lineage fields", "required_lineage_fields": m["required_lineage_fields"]}),
        source_package("srcpkg-campaign12-complete-lineage-count", f"Campaign 12 records {m['complete_lineage_artifact_count']} Environment artifacts with all required provenance-lineage fields present.", "derived", snapshot, {"topic": "complete lineage count", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"]}),
        source_package("srcpkg-campaign12-missing-lineage-count", f"Campaign 12 records {m['missing_lineage_field_count']} missing required lineage fields in the audited Environment lineage snapshot.", "negative", snapshot, {"topic": "missing lineage count", "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign12-lineage-completeness-classification", "Campaign 12 classifies the audited WDI Environment provenance-lineage snapshot as complete for the required lineage field set.", "classified", snapshot, {"topic": "lineage completeness classification", "all_required_lineage_fields_present": m["all_required_lineage_fields_present"]}),
        source_package("srcpkg-campaign12-raw-artifact-hash-coverage", f"Campaign 12 records raw artifact hashes for {m['raw_artifact_hash_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "raw artifact hash coverage", "raw_artifact_hash_count": m["raw_artifact_hash_count"]}),
        source_package("srcpkg-campaign12-raw-artifact-url-coverage", f"Campaign 12 records raw artifact URLs for {m['raw_artifact_url_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "raw artifact url coverage", "raw_artifact_url_count": m["raw_artifact_url_count"]}),
        source_package("srcpkg-campaign12-release-key-coverage", f"Campaign 12 records release keys for {m['release_key_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "release key coverage", "release_key_count": m["release_key_count"]}),
        source_package("srcpkg-campaign12-source-url-coverage", f"Campaign 12 records source URLs for {m['source_url_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "source url coverage", "source_url_count": m["source_url_count"]}),
        source_package("srcpkg-campaign12-license-note-coverage", f"Campaign 12 records license notes for {m['license_note_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "license note coverage", "license_note_count": m["license_note_count"]}),
        source_package("srcpkg-campaign12-lineage-envelope-coverage", f"Campaign 12 records provenance envelope presence for {m['lineage_envelope_count']} audited WDI Environment artifacts.", "coverage", snapshot, {"topic": "lineage envelope coverage", "lineage_envelope_count": m["lineage_envelope_count"]}),
        source_package("srcpkg-campaign12-quality-control-state", "Campaign 12 quality control confirms required lineage fields, lineage fingerprint inputs, source identity, release metadata, and non-interpretive scope for Environment provenance-lineage closeout.", "evidence_quality", snapshot, {"topic": "quality control state", **qc}),
        source_package("srcpkg-campaign12-validation-state", "Campaign 12 routes Environment provenance-lineage packages through the existing validation pipeline without validator, taxonomy, package-model, Production Support, provenance, fingerprint, or reporting modification.", "methodological", snapshot, {"topic": "validation state", "pipeline_modified": False, "validator_modified": False, "taxonomy_modified": False, "production_support_modified": False}),
        source_package("srcpkg-campaign12-deterministic-lineage-transform", "Campaign 12 derives Environment lineage completeness counts deterministically from the immutable artifact lineage snapshot.", "methodological", snapshot, {"topic": "deterministic lineage transform", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"], "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign12-environment-family-maturity-assessment", "Campaigns 8-12 support Mature status for the WDI Environment production family using the established Family Closeout methodology unchanged.", "methodological", snapshot, {"topic": "Environment family maturity", **maturity}),
        source_package("srcpkg-campaign12-production-methodology-assessment", "Campaign 12 records the KnowledgeForge production methodology as validated across two Mature WDI annual-scalar production families without architecture refinement.", "methodological", snapshot, {"topic": "production methodology assessment", **method}),
        source_package("srcpkg-campaign12-architectural-continuity-review", "Campaign 12 architectural continuity review classifies the next-phase path as preserving the agreed architecture and identifies no refinement, duplicate concept, contradiction, or architectural drift.", "methodological", snapshot, {"topic": "architectural continuity review", "authoritative_design_reviewed": continuity["authoritative_design_reviewed"], "default_posture": continuity["default_posture"], "refinements_supported": continuity["refinements_supported"], "contradictions_or_drift": continuity["contradictions_or_drift"]}),
    ]
...
def build_rejected_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    boundary = source_package("srcpkg-campaign12-reject-boundary-language", "This Environment lineage record is a causal claim and includes a forecast about future evidence value.", "provenance", snapshot, {"topic": "boundary rejection"})
    missing_provenance = source_package("srcpkg-campaign12-reject-missing-provenance", "A malformed Campaign 12 Environment candidate omits provenance fields.", "provenance", snapshot, {"topic": "malformed provenance"})
    missing_provenance.pop("provenance")
    missing_fingerprint = source_package("srcpkg-campaign12-reject-missing-fingerprint", "A malformed Campaign 12 Environment candidate omits lineage fingerprints.", "provenance", snapshot, {"topic": "malformed fingerprint"})
    missing_fingerprint.pop("fingerprints")
    unsupported_category = source_package("srcpkg-campaign12-reject-unsupported-category", "A malformed Campaign 12 Environment candidate uses an unsupported lineage-rating category.", "lineage_rating", snapshot, {"topic": "unsupported category"})
...
def write_reports(output: Path, result: dict[str, Any]) -> None:
    ...
    (reports / "campaign_12_final_report.md").write_text(f"""# Campaign 12 Final Report

Campaign: {CAMPAIGN_ID}

Campaign 12 completed WDI Environment provenance-lineage validation and family closeout using the existing KnowledgeForge production model unchanged.

- Accepted KnowledgeObjectPackages: {q['knowledge_object_packages_accepted']}
- Rejected candidates: {q['rejected_candidates']}
- Environment family maturity: {q['environment_family_maturity_assessment']['classification']}
...
Comparison with Campaign 7: Environment provenance-lineage closeout matched the demographic provenance-lineage closeout pattern without architecture, taxonomy, validator, package, provenance, fingerprint, reporting, or Production Support change.

Comparison with Campaigns 8-11: Campaign 12 completes the missing Environment dedicated provenance-lineage and family closeout evidence identified by Campaign 11.
""", encoding="utf-8")
    maturity = q["environment_family_maturity_assessment"]
...
""", encoding="utf-8")
    (reports / "environment_family_closeout_report.md").write_text(f"""# WDI Environment Production Family Closeout Report

Status: Mature
Evidence base: Campaigns 8-12
...
- The existing KnowledgeForge package hierarchy is sufficient for the WDI Environment evidence family.
...
- Existing categories support planned WDI Environment evidence-level scopes without taxonomy change.
...
- Environment maturity no longer lacks dedicated provenance-lineage completeness.
- Second-family methodology transfer has now reached family closeout.
- No duplicate-registry, validator, taxonomy, helper-extraction, or architecture pressure remains from Environment maturation.
...
- The demographic family closeout criteria transferred unchanged to Environment.
...
Status: validated across two Mature WDI annual-scalar production families
Evidence base: WDI demographic Campaigns 1-7 and WDI Environment Campaigns 8-12
...
Campaign 12 supports preserving the existing KnowledgeForge architecture unchanged.

Continuity classification for recommendations:

- Environment family Mature classification: preserves agreed architecture.
- Production methodology validated across two Mature WDI annual-scalar families: preserves agreed architecture.
- Broadening into a third evidence family using the established methodology unchanged: preserves agreed architecture.
...
def run_campaign(output: Path) -> dict[str, Any]:
    snapshot = immutable_wdi_environment_provenance_lineage_snapshot()
    ...
    quality_report = {
        **base,
        ...
        "environment_family_maturity_assessment": snapshot["environment_family_maturity"],
        ...
        "comparison_against_campaign7": {"campaign7_family_maturity": "Mature", "campaign12_family_maturity": "Mature", "provenance_lineage_closeout_pattern": "transferred unchanged"},
        "comparison_against_campaigns8_11": {"campaign8_11_environment_status": "Stable before dedicated provenance-lineage closeout", "campaign12_addition": "dedicated Environment provenance-lineage completeness and family closeout"},
        ...
        "candidate_improvements_discovered": ["No implementation or architecture change is justified by Campaign 12."],
        "recommendation_architectural_classification": "preserves agreed architecture",
        "minimum_remaining_evidence_before_transition": "none for WDI annual-scalar third-family broadening; non-WDI multi-source disagreement remains a later falsification gap",
        "final_recommendation": "Broaden into a third evidence family using the established production methodology unchanged.",
    ...
    result = {"snapshot": snapshot, "source_packages": source_packages, "knowledge_candidates": candidates, "accepted_objects": accepted, "rejected_records": rejected, "quality_report": quality_report}
    if output.exists():
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Campaign 12 WDI Environment provenance-lineage closeout")
    ...
    print(json.dumps({
        ...
        "environment_maturity": q["environment_family_maturity_assessment"]["classification"],
