#!/usr/bin/env python3
"""Campaign 24: WDI Health provenance-lineage completeness and closeout.
...
CAMPAIGN_ID = "campaign-24-wdi-health-provenance-lineage-closeout"
...
def immutable_wdi_health_provenance_lineage_snapshot() -> dict[str, Any]:
    artifacts = [
        {
            "artifact_key": "wdi_health_indicator_metadata_snapshot",
            "raw_artifact_url": "https://api.worldbank.org/v2/indicator?format=json&per_page=20000&source=2&topic=health",
            "raw_artifact_hash": "sha256:912d0e5946f12a0d706533dfa1c8634f28a48c3c97242f6c0c89a9fbf0121501",
            "release_key": "WDI-2026-06-health-metadata",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Health provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_health_country_catalog_snapshot",
        ...
        {
            "artifact_key": "wdi_health_annual_scalar_values_snapshot",
            ...
            "release_key": "WDI-2026-06-health-values",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Health provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_health_release_metadata_snapshot",
        ...
        {
            "artifact_key": "wdi_health_family_coverage_matrix_snapshot",
            "raw_artifact_url": "file://artifacts/production/campaign-23-wdi-health-indicator-family-coverage-maturation/source_snapshot.json",
            "raw_artifact_hash": "sha256:bb11c51973c57b815354dbd99a704cc41c0aefbbb08e998068e5539b4ce493b5",
            "release_key": "KnowledgeForge-Campaign-14-health-coverage-maturation",
            "source_url": "artifacts/production/campaign-23-wdi-health-indicator-family-coverage-maturation/source_snapshot.json",
            "license_note": "Derived from WDI Health evidence under KnowledgeForge deterministic production scope",
            "lineage_envelope_present": True,
        },
    ]
    ...
    continuity_review = {
        ...
        "recommendations": [
            {"recommendation": "classify WDI Health as Mature after Campaign 24", "classification": "preserves agreed architecture", "evidence": "Campaigns 22-24 complete the established family maturity criteria without architecture change"},
            {"recommendation": "treat production methodology as validated across six mature WDI annual-scalar families", "classification": "preserves agreed architecture", "evidence": "Demographic, Environment, Infrastructure, Energy & Mining, Agriculture & Rural Development, and Health family closeouts satisfy the same production methodology without contract changes"},
            {"recommendation": "proceed to WDI Education annual-scalar evidence using the established methodology unchanged", "classification": "preserves agreed architecture", "evidence": "Six families reached Mature; no repeated production evidence shows current design insufficiency"},
        ],
    ...
    snapshot = {
        ...
        "evidence_family": "external_wdi_annual_scalar_health_provenance_lineage",
        "scope": {
        ...
        "health_family_maturity": {
            "classification": "Mature",
            "basis": "Campaigns 22-24 validate deterministic WDI Health production across evidence-quality transfer, cross-family comparison, recurrence-audit participation, indicator-family inventory, territorial coverage, temporal coverage, and provenance-lineage completeness without architecture change.",
            "validated": [
        ...
        "production_methodology_assessment": {
            "classification": "preserved_across_six_wdi_families",
            "basis": "WDI demographic, WDI Environment, WDI Infrastructure, WDI Energy & Mining, WDI Agriculture & Rural Development, and WDI Health families reached Mature using the same deterministic package hierarchy, validators, Production Support layer, provenance/fingerprint model, reporting model, rejected-candidate preservation, and family closeout method.",
        ...
        "evidence_basis": [
            ...
            "artifacts/production/campaign-23-wdi-health-indicator-family-coverage-maturation/production_quality_report.json",
...
def package_scope(topic: str) -> dict[str, Any]:
    return {"domain": "WDI annual-scalar Health provenance-lineage completeness and family closeout", "campaign_id": CAMPAIGN_ID, "topic": topic, "scope_type": "external_health_provenance_lineage_metadata", "exclusions": SAFE_EXCLUSIONS}
...
def source_package(package_id: str, statement: str, category: str, snapshot: dict[str, Any], metadata: dict[str, Any]) -> dict[str, Any]:
    return production_support.build_source_evidence_package(
        ...
        source_name="World Bank World Development Indicators audited Health provenance lineage snapshot",
        source_family=snapshot["evidence_family"],
        source_version=snapshot["snapshot_fingerprint"],
        scope=package_scope(metadata.get("topic", "Health provenance lineage")),
        payload_metadata=metadata,
        evidence_class="external_observational_metadata",
        classification={"generated_by_llm": False, "contains_observational_values": False, "direct_evidence": True, "evidence_kind": "audited_wdi_health_provenance_lineage", "campaign_id": CAMPAIGN_ID},
        ...
        provenance={"source_snapshot_id": snapshot["snapshot_fingerprint"], "source_snapshot_date": CAMPAIGN_DATE, "evidence_basis": snapshot["evidence_basis"], "selection_rule": "approved Campaign 24 WDI Health provenance-lineage closeout scope", "source_family": snapshot["evidence_family"]},
        reproducibility={"state": "reproducible", "handle": f"python3 tools/run_campaign24_wdi_health_provenance_lineage_closeout.py --output artifacts/production/{CAMPAIGN_ID}", "rerun_method": "deterministic embedded immutable Health provenance-lineage snapshot and canonical JSON construction", "nondeterminism": "none"},
...
def build_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    maturity = snapshot["health_family_maturity"]
    method = snapshot["production_methodology_assessment"]
    continuity = snapshot["architectural_continuity_review"]
    return [
        source_package("srcpkg-campaign24-artifact-count", f"The Campaign 24 WDI Health provenance-lineage snapshot contains {m['artifact_count']} raw artifact identity records.", "factual", snapshot, {"topic": "artifact count", "artifact_count": m["artifact_count"]}),
        source_package("srcpkg-campaign24-required-lineage-fields", "Campaign 24 required lineage fields are raw artifact URL, raw artifact hash, release key, source URL, license note, and provenance envelope presence.", "provenance", snapshot, {"topic": "required lineage fields", "required_lineage_fields": m["required_lineage_fields"]}),
        source_package("srcpkg-campaign24-complete-lineage-count", f"Campaign 24 records {m['complete_lineage_artifact_count']} Health artifacts with all required provenance-lineage fields present.", "derived", snapshot, {"topic": "complete lineage count", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"]}),
        source_package("srcpkg-campaign24-missing-lineage-count", f"Campaign 24 records {m['missing_lineage_field_count']} missing required lineage fields in the audited Health lineage snapshot.", "negative", snapshot, {"topic": "missing lineage count", "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign24-lineage-completeness-classification", "Campaign 24 classifies the audited WDI Health provenance-lineage snapshot as complete for the required lineage field set.", "classified", snapshot, {"topic": "lineage completeness classification", "all_required_lineage_fields_present": m["all_required_lineage_fields_present"]}),
        source_package("srcpkg-campaign24-raw-artifact-hash-coverage", f"Campaign 24 records raw artifact hashes for {m['raw_artifact_hash_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "raw artifact hash coverage", "raw_artifact_hash_count": m["raw_artifact_hash_count"]}),
        source_package("srcpkg-campaign24-raw-artifact-url-coverage", f"Campaign 24 records raw artifact URLs for {m['raw_artifact_url_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "raw artifact url coverage", "raw_artifact_url_count": m["raw_artifact_url_count"]}),
        source_package("srcpkg-campaign24-release-key-coverage", f"Campaign 24 records release keys for {m['release_key_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "release key coverage", "release_key_count": m["release_key_count"]}),
        source_package("srcpkg-campaign24-source-url-coverage", f"Campaign 24 records source URLs for {m['source_url_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "source url coverage", "source_url_count": m["source_url_count"]}),
        source_package("srcpkg-campaign24-license-note-coverage", f"Campaign 24 records license notes for {m['license_note_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "license note coverage", "license_note_count": m["license_note_count"]}),
        source_package("srcpkg-campaign24-lineage-envelope-coverage", f"Campaign 24 records provenance envelope presence for {m['lineage_envelope_count']} audited WDI Health artifacts.", "coverage", snapshot, {"topic": "lineage envelope coverage", "lineage_envelope_count": m["lineage_envelope_count"]}),
        source_package("srcpkg-campaign24-quality-control-state", "Campaign 24 quality control confirms required lineage fields, lineage fingerprint inputs, source identity, release metadata, and non-interpretive scope for Health provenance-lineage closeout.", "evidence_quality", snapshot, {"topic": "quality control state", **qc}),
        source_package("srcpkg-campaign24-validation-state", "Campaign 24 routes Health provenance-lineage packages through the existing validation pipeline without validator, taxonomy, package-model, Production Support, provenance, fingerprint, or reporting modification.", "methodological", snapshot, {"topic": "validation state", "pipeline_modified": False, "validator_modified": False, "taxonomy_modified": False, "production_support_modified": False}),
        source_package("srcpkg-campaign24-deterministic-lineage-transform", "Campaign 24 derives Health lineage completeness counts deterministically from the immutable artifact lineage snapshot.", "methodological", snapshot, {"topic": "deterministic lineage transform", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"], "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign24-health-family-maturity-assessment", "Campaigns 22-24 support Mature status for the WDI Health production family using the established Family Closeout methodology unchanged.", "methodological", snapshot, {"topic": "Health family maturity", **maturity}),
        source_package("srcpkg-campaign24-production-methodology-assessment", "Campaign 24 records the KnowledgeForge production methodology as preserved across six Mature WDI annual-scalar production families without architecture refinement.", "methodological", snapshot, {"topic": "production methodology assessment", **method}),
        source_package("srcpkg-campaign24-architectural-continuity-review", "Campaign 24 architectural continuity review classifies the next-phase path as preserving the agreed architecture and identifies no refinement, duplicate concept, contradiction, or architectural drift.", "methodological", snapshot, {"topic": "architectural continuity review", "authoritative_design_reviewed": continuity["authoritative_design_reviewed"], "default_posture": continuity["default_posture"], "refinements_supported": continuity["refinements_supported"], "contradictions_or_drift": continuity["contradictions_or_drift"]}),
    ]
...
def build_rejected_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    boundary = source_package("srcpkg-campaign24-reject-boundary-language", "This Health lineage record is a causal claim and includes a forecast about future evidence value.", "provenance", snapshot, {"topic": "boundary rejection"})
    missing_provenance = source_package("srcpkg-campaign24-reject-missing-provenance", "A malformed Campaign 24 Health candidate omits provenance fields.", "provenance", snapshot, {"topic": "malformed provenance"})
    missing_provenance.pop("provenance")
    missing_fingerprint = source_package("srcpkg-campaign24-reject-missing-fingerprint", "A malformed Campaign 24 Health candidate omits lineage fingerprints.", "provenance", snapshot, {"topic": "malformed fingerprint"})
    missing_fingerprint.pop("fingerprints")
    unsupported_category = source_package("srcpkg-campaign24-reject-unsupported-category", "A malformed Campaign 24 Health candidate uses an unsupported lineage-rating category.", "lineage_rating", snapshot, {"topic": "unsupported category"})
...
def repository_impact_assessment(accepted_objects: list[dict[str, Any]], health: dict[str, Any], previous_count: int) -> dict[str, Any]:
    ...
    return {
        ...
        "new_reusable_knowledge_introduced": [
            "Health provenance-lineage artifact completeness",
            "Health raw artifact hash and URL completeness",
            "Health release-key/source-url/license lineage completeness",
            "Health family Mature closeout state",
        ],
        "knowledge_categories_expanded": categories,
        "evidence_family_coverage_expanded": evidence_families,
        "repository_breadth_gained": ["completed sixth WDI annual-scalar family closeout in the operational repository", "added Health provenance-lineage evidence family"],
        "repository_depth_gained": ["deepened Health from transfer and maturation evidence into provenance-lineage closeout", "added reusable family maturity evidence for downstream production sequencing"],
        ...
        "future_recomputation_avoided_for_downstream_projects": ["downstream projects can reuse Health provenance-lineage completeness without recomputing artifact lineage", "downstream projects can reuse Health Mature status and closeout basis", "downstream projects can reuse raw artifact/source/release/license completeness counts"],
        ...
        "repository_quality_improvements_achieved": ["repository now contains complete Health family closeout evidence", "provenance completeness remained true", "fingerprint stability remained true", "repository object count increased with no unresolved repository-quality concerns"],
    }
...
def write_reports(output: Path, result: dict[str, Any]) -> None:
    ...
    (reports / "campaign_24_final_report.md").write_text(f"""# Campaign 24 Final Report

Campaign: {CAMPAIGN_ID}

Campaign 24 completed WDI Health provenance-lineage validation and family closeout using the existing KnowledgeForge production model unchanged.

- Accepted KnowledgeObjectPackages: {q['knowledge_object_packages_accepted']}
- Rejected candidates: {q['rejected_candidates']}
- Health family maturity: {q['health_family_maturity_assessment']['classification']}
...
Comparison with Campaign 7: Health provenance-lineage closeout matched the demographic provenance-lineage closeout pattern without architecture, taxonomy, validator, package, provenance, fingerprint, reporting, or Production Support change.

Comparison with Campaigns 8-11: Campaign 24 completes the missing Health dedicated provenance-lineage and family closeout evidence identified by Campaign 11.
""", encoding="utf-8")
    maturity = q["health_family_maturity_assessment"]
...
""", encoding="utf-8")
    (reports / "health_family_closeout_report.md").write_text(f"""# WDI Health Production Family Closeout Report

Status: Mature
Evidence base: Campaigns 22-24
...
- The existing KnowledgeForge package hierarchy is sufficient for the WDI Health evidence family.
...
- Existing categories support planned WDI Health evidence-level scopes without taxonomy change.
...
- Health maturity no longer lacks dedicated provenance-lineage completeness.
- Second-family methodology transfer has now reached family closeout.
- No duplicate-registry, validator, taxonomy, helper-extraction, or architecture pressure remains from Health maturation.
...
- The demographic family closeout criteria transferred unchanged to Health.
...
Status: preserved across six Mature WDI annual-scalar production families
Evidence base: WDI demographic Campaigns 1-7, Environment Campaigns 8-12, Infrastructure Campaigns 13-15, Energy & Mining Campaigns 16-18, Agriculture & Rural Development Campaigns 19-21, and Health Campaigns 22-24
...
Campaign 24 supports preserving the existing KnowledgeForge architecture unchanged.

Continuity classification for recommendations:

- Health family Mature classification: preserves agreed architecture.
- Production methodology preserved across six Mature WDI annual-scalar families: preserves agreed architecture.
- Proceeding to WDI Education using the established methodology unchanged: preserves agreed architecture.
...
def run_campaign(output: Path, repository_root: Path | None = None) -> dict[str, Any]:
    snapshot = immutable_wdi_health_provenance_lineage_snapshot()
    ...
    quality_report = {
        **base,
        ...
        "health_family_maturity_assessment": snapshot["health_family_maturity"],
        ...
        "comparison_against_prior_closeouts": {"campaign7_family_maturity": "Mature", "campaign12_family_maturity": "Mature", "campaign24_family_maturity": "Mature", "provenance_lineage_closeout_pattern": "transferred unchanged"},
        "comparison_against_campaigns13_14": {"campaign22_14_health_status": "Stable before dedicated provenance-lineage closeout", "campaign24_addition": "dedicated Health provenance-lineage completeness and family closeout"},
        ...
        "candidate_improvements_discovered": ["No implementation or architecture change is justified by Campaign 24."],
        ...
        "minimum_remaining_evidence_before_transition": "none for WDI Health annual-scalar family entry; non-WDI multi-source disagreement remains a later falsification gap",
        "final_recommendation": "Proceed to WDI Education annual-scalar evidence as the next Phase 2 production family using the established Production Doctrine unchanged.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Campaign 24 WDI Health provenance-lineage closeout")
    ...
    print(json.dumps({
        ...
        "health_maturity": q["health_family_maturity_assessment"]["classification"],
