#!/usr/bin/env python3
"""Campaign 18: WDI Energy & Mining provenance-lineage completeness and closeout.
...
CAMPAIGN_ID = "campaign-18-wdi-energy-mining-provenance-lineage-closeout"
...
def immutable_wdi_energy_mining_provenance_lineage_snapshot() -> dict[str, Any]:
    artifacts = [
        {
            "artifact_key": "wdi_energy_mining_indicator_metadata_snapshot",
            ...
            "release_key": "WDI-2026-06-energy_mining-metadata",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Energy & Mining provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_energy_mining_country_catalog_snapshot",
        ...
        {
            "artifact_key": "wdi_energy_mining_annual_scalar_values_snapshot",
            ...
            "release_key": "WDI-2026-06-energy_mining-values",
            "source_url": "https://databank.worldbank.org/source/world-development-indicators",
            "license_note": "World Bank WDI terms noted for Energy & Mining provenance tracking",
            "lineage_envelope_present": True,
        },
        {
            "artifact_key": "wdi_energy_mining_release_metadata_snapshot",
        ...
        {
            "artifact_key": "wdi_energy_mining_family_coverage_matrix_snapshot",
            "raw_artifact_url": "file://artifacts/production/campaign-17-wdi-energy-mining-indicator-family-coverage-maturation/source_snapshot.json",
            "raw_artifact_hash": "sha256:bb11c51973c57b815354dbd99a704cc41c0aefbbb08e998068e5539b4ce493b5",
            "release_key": "KnowledgeForge-Campaign-14-energy_mining-coverage-maturation",
            "source_url": "artifacts/production/campaign-17-wdi-energy-mining-indicator-family-coverage-maturation/source_snapshot.json",
            "license_note": "Derived from WDI Energy & Mining evidence under KnowledgeForge deterministic production scope",
            "lineage_envelope_present": True,
        },
    ]
    ...
    continuity_review = {
        ...
        "recommendations": [
            {"recommendation": "classify WDI Energy & Mining as Mature after Campaign 18", "classification": "preserves agreed architecture", "evidence": "Campaigns 16-18 complete the established family maturity criteria without architecture change"},
            {"recommendation": "treat production methodology as validated across four mature WDI annual-scalar families", "classification": "preserves agreed architecture", "evidence": "Demographic, Environment, Infrastructure, and Energy & Mining family closeouts satisfy the same production methodology without contract changes"},
            {"recommendation": "proceed to WDI Agriculture & Rural Development annual-scalar evidence using the established methodology unchanged", "classification": "preserves agreed architecture", "evidence": "Four families reached Mature; no repeated production evidence shows current design insufficiency"},
        ],
    ...
    snapshot = {
        ...
        "evidence_family": "external_wdi_annual_scalar_energy_mining_provenance_lineage",
        "scope": {
        ...
        "energy_mining_family_maturity": {
            "classification": "Mature",
            "basis": "Campaigns 16-18 validate deterministic WDI Energy & Mining production across evidence-quality transfer, cross-family comparison, recurrence-audit participation, indicator-family inventory, territorial coverage, temporal coverage, and provenance-lineage completeness without architecture change.",
            "validated": [
        ...
        "production_methodology_assessment": {
            "classification": "preserved_across_four_wdi_families",
            "basis": "WDI demographic, WDI Environment, WDI Infrastructure, and WDI Energy & Mining families reached Mature using the same deterministic package hierarchy, validators, Production Support layer, provenance/fingerprint model, reporting model, rejected-candidate preservation, and family closeout method.",
        ...
        "evidence_basis": [
            ...
            "artifacts/production/campaign-7-wdi-demographic-structure-provenance-lineage-completeness/reports/family_closeout_report.md",
            "artifacts/production/campaign-8-wdi-energy_mining-annual-scalar-evidence-quality-coverage-transfer/production_quality_report.json",
            ...
            "artifacts/production/campaign-17-wdi-energy-mining-indicator-family-coverage-maturation/production_quality_report.json",
        ],
    }
...
def package_scope(topic: str) -> dict[str, Any]:
    return {"domain": "WDI annual-scalar Energy & Mining provenance-lineage completeness and family closeout", "campaign_id": CAMPAIGN_ID, "topic": topic, "scope_type": "external_energy_mining_provenance_lineage_metadata", "exclusions": SAFE_EXCLUSIONS}
...
def source_package(package_id: str, statement: str, category: str, snapshot: dict[str, Any], metadata: dict[str, Any]) -> dict[str, Any]:
    return production_support.build_source_evidence_package(
        ...
        source_name="World Bank World Development Indicators audited Energy & Mining provenance lineage snapshot",
        source_family=snapshot["evidence_family"],
        source_version=snapshot["snapshot_fingerprint"],
        scope=package_scope(metadata.get("topic", "Energy & Mining provenance lineage")),
        payload_metadata=metadata,
        evidence_class="external_observational_metadata",
        classification={"generated_by_llm": False, "contains_observational_values": False, "direct_evidence": True, "evidence_kind": "audited_wdi_energy_mining_provenance_lineage", "campaign_id": CAMPAIGN_ID},
        ...
        provenance={"source_snapshot_id": snapshot["snapshot_fingerprint"], "source_snapshot_date": CAMPAIGN_DATE, "evidence_basis": snapshot["evidence_basis"], "selection_rule": "approved Campaign 18 WDI Energy & Mining provenance-lineage closeout scope", "source_family": snapshot["evidence_family"]},
        reproducibility={"state": "reproducible", "handle": f"python3 tools/run_campaign18_wdi_energy_mining_provenance_lineage_closeout.py --output artifacts/production/{CAMPAIGN_ID}", "rerun_method": "deterministic embedded immutable Energy & Mining provenance-lineage snapshot and canonical JSON construction", "nondeterminism": "none"},
...
def build_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    maturity = snapshot["energy_mining_family_maturity"]
    method = snapshot["production_methodology_assessment"]
    continuity = snapshot["architectural_continuity_review"]
    return [
        source_package("srcpkg-campaign18-artifact-count", f"The Campaign 18 WDI Energy & Mining provenance-lineage snapshot contains {m['artifact_count']} raw artifact identity records.", "factual", snapshot, {"topic": "artifact count", "artifact_count": m["artifact_count"]}),
        source_package("srcpkg-campaign18-required-lineage-fields", "Campaign 18 required lineage fields are raw artifact URL, raw artifact hash, release key, source URL, license note, and provenance envelope presence.", "provenance", snapshot, {"topic": "required lineage fields", "required_lineage_fields": m["required_lineage_fields"]}),
        source_package("srcpkg-campaign18-complete-lineage-count", f"Campaign 18 records {m['complete_lineage_artifact_count']} Energy & Mining artifacts with all required provenance-lineage fields present.", "derived", snapshot, {"topic": "complete lineage count", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"]}),
        source_package("srcpkg-campaign18-missing-lineage-count", f"Campaign 18 records {m['missing_lineage_field_count']} missing required lineage fields in the audited Energy & Mining lineage snapshot.", "negative", snapshot, {"topic": "missing lineage count", "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign18-lineage-completeness-classification", "Campaign 18 classifies the audited WDI Energy & Mining provenance-lineage snapshot as complete for the required lineage field set.", "classified", snapshot, {"topic": "lineage completeness classification", "all_required_lineage_fields_present": m["all_required_lineage_fields_present"]}),
        source_package("srcpkg-campaign18-raw-artifact-hash-coverage", f"Campaign 18 records raw artifact hashes for {m['raw_artifact_hash_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "raw artifact hash coverage", "raw_artifact_hash_count": m["raw_artifact_hash_count"]}),
        source_package("srcpkg-campaign18-raw-artifact-url-coverage", f"Campaign 18 records raw artifact URLs for {m['raw_artifact_url_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "raw artifact url coverage", "raw_artifact_url_count": m["raw_artifact_url_count"]}),
        source_package("srcpkg-campaign18-release-key-coverage", f"Campaign 18 records release keys for {m['release_key_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "release key coverage", "release_key_count": m["release_key_count"]}),
        source_package("srcpkg-campaign18-source-url-coverage", f"Campaign 18 records source URLs for {m['source_url_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "source url coverage", "source_url_count": m["source_url_count"]}),
        source_package("srcpkg-campaign18-license-note-coverage", f"Campaign 18 records license notes for {m['license_note_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "license note coverage", "license_note_count": m["license_note_count"]}),
        source_package("srcpkg-campaign18-lineage-envelope-coverage", f"Campaign 18 records provenance envelope presence for {m['lineage_envelope_count']} audited WDI Energy & Mining artifacts.", "coverage", snapshot, {"topic": "lineage envelope coverage", "lineage_envelope_count": m["lineage_envelope_count"]}),
        source_package("srcpkg-campaign18-quality-control-state", "Campaign 18 quality control confirms required lineage fields, lineage fingerprint inputs, source identity, release metadata, and non-interpretive scope for Energy & Mining provenance-lineage closeout.", "evidence_quality", snapshot, {"topic": "quality control state", **qc}),
        source_package("srcpkg-campaign18-validation-state", "Campaign 18 routes Energy & Mining provenance-lineage packages through the existing validation pipeline without validator, taxonomy, package-model, Production Support, provenance, fingerprint, or reporting modification.", "methodological", snapshot, {"topic": "validation state", "pipeline_modified": False, "validator_modified": False, "taxonomy_modified": False, "production_support_modified": False}),
        source_package("srcpkg-campaign18-deterministic-lineage-transform", "Campaign 18 derives Energy & Mining lineage completeness counts deterministically from the immutable artifact lineage snapshot.", "methodological", snapshot, {"topic": "deterministic lineage transform", "complete_lineage_artifact_count": m["complete_lineage_artifact_count"], "missing_lineage_field_count": m["missing_lineage_field_count"]}),
        source_package("srcpkg-campaign18-energy_mining-family-maturity-assessment", "Campaigns 16-18 support Mature status for the WDI Energy & Mining production family using the established Family Closeout methodology unchanged.", "methodological", snapshot, {"topic": "Energy & Mining family maturity", **maturity}),
        source_package("srcpkg-campaign18-production-methodology-assessment", "Campaign 18 records the KnowledgeForge production methodology as preserved across four Mature WDI annual-scalar production families without architecture refinement.", "methodological", snapshot, {"topic": "production methodology assessment", **method}),
        source_package("srcpkg-campaign18-architectural-continuity-review", "Campaign 18 architectural continuity review classifies the next-phase path as preserving the agreed architecture and identifies no refinement, duplicate concept, contradiction, or architectural drift.", "methodological", snapshot, {"topic": "architectural continuity review", "authoritative_design_reviewed": continuity["authoritative_design_reviewed"], "default_posture": continuity["default_posture"], "refinements_supported": continuity["refinements_supported"], "contradictions_or_drift": continuity["contradictions_or_drift"]}),
    ]
...
def build_rejected_source_packages(snapshot: dict[str, Any]) -> list[dict[str, Any]]:
    boundary = source_package("srcpkg-campaign18-reject-boundary-language", "This Energy & Mining lineage record is a causal claim and includes a forecast about future evidence value.", "provenance", snapshot, {"topic": "boundary rejection"})
    missing_provenance = source_package("srcpkg-campaign18-reject-missing-provenance", "A malformed Campaign 18 Energy & Mining candidate omits provenance fields.", "provenance", snapshot, {"topic": "malformed provenance"})
    missing_provenance.pop("provenance")
    missing_fingerprint = source_package("srcpkg-campaign18-reject-missing-fingerprint", "A malformed Campaign 18 Energy & Mining candidate omits lineage fingerprints.", "provenance", snapshot, {"topic": "malformed fingerprint"})
    missing_fingerprint.pop("fingerprints")
    unsupported_category = source_package("srcpkg-campaign18-reject-unsupported-category", "A malformed Campaign 18 Energy & Mining candidate uses an unsupported lineage-rating category.", "lineage_rating", snapshot, {"topic": "unsupported category"})
...
def repository_impact_assessment(accepted_objects: list[dict[str, Any]], health: dict[str, Any], previous_count: int) -> dict[str, Any]:
    ...
    return {
        ...
        "new_reusable_knowledge_introduced": [
            "Energy & Mining provenance-lineage artifact completeness",
            "Energy & Mining raw artifact hash and URL completeness",
            "Energy & Mining release-key/source-url/license lineage completeness",
            "Energy & Mining family Mature closeout state",
        ],
        "knowledge_categories_expanded": categories,
        "evidence_family_coverage_expanded": evidence_families,
        "repository_breadth_gained": ["completed fourth WDI annual-scalar family closeout in the operational repository", "added Energy & Mining provenance-lineage evidence family"],
        "repository_depth_gained": ["deepened Energy & Mining from transfer and maturation evidence into provenance-lineage closeout", "added reusable family maturity evidence for downstream production sequencing"],
        ...
        "future_recomputation_avoided_for_downstream_projects": ["downstream projects can reuse Energy & Mining provenance-lineage completeness without recomputing artifact lineage", "downstream projects can reuse Energy & Mining Mature status and closeout basis", "downstream projects can reuse raw artifact/source/release/license completeness counts"],
        ...
        "repository_quality_improvements_achieved": ["repository now contains complete Energy & Mining family closeout evidence", "provenance completeness remained true", "fingerprint stability remained true", "repository object count increased with no unresolved repository-quality concerns"],
    }
...
def write_reports(output: Path, result: dict[str, Any]) -> None:
    ...
    (reports / "campaign_18_final_report.md").write_text(f"""# Campaign 18 Final Report

Campaign: {CAMPAIGN_ID}

Campaign 18 completed WDI Energy & Mining provenance-lineage validation and family closeout using the existing KnowledgeForge production model unchanged.

- Accepted KnowledgeObjectPackages: {q['knowledge_object_packages_accepted']}
- Rejected candidates: {q['rejected_candidates']}
- Energy & Mining family maturity: {q['energy_mining_family_maturity_assessment']['classification']}
...
Comparison with Campaign 7: Energy & Mining provenance-lineage closeout matched the demographic provenance-lineage closeout pattern without architecture, taxonomy, validator, package, provenance, fingerprint, reporting, or Production Support change.

Comparison with Campaigns 8-11: Campaign 18 completes the missing Energy & Mining dedicated provenance-lineage and family closeout evidence identified by Campaign 11.
""", encoding="utf-8")
    maturity = q["energy_mining_family_maturity_assessment"]
    (reports / "energy_mining_family_maturity_assessment.md").write_text(f"""# Energy & Mining Family Maturity Assessment
...
""", encoding="utf-8")
    (reports / "energy_mining_family_closeout_report.md").write_text(f"""# WDI Energy & Mining Production Family Closeout Report

Status: Mature
Evidence base: Campaigns 16-18
...
- The existing KnowledgeForge package hierarchy is sufficient for the WDI Energy & Mining evidence family.
...
- Existing categories support planned WDI Energy & Mining evidence-level scopes without taxonomy change.
...
- Energy & Mining maturity no longer lacks dedicated provenance-lineage completeness.
- Second-family methodology transfer has now reached family closeout.
- No duplicate-registry, validator, taxonomy, helper-extraction, or architecture pressure remains from Energy & Mining maturation.
...
- The demographic family closeout criteria transferred unchanged to Energy & Mining.
...
Status: preserved across four Mature WDI annual-scalar production families
Evidence base: WDI demographic Campaigns 1-7 and WDI Energy & Mining Campaigns 16-18
...
Campaign 18 supports preserving the existing KnowledgeForge architecture unchanged.

Continuity classification for recommendations:

- Energy & Mining family Mature classification: preserves agreed architecture.
- Production methodology preserved across four Mature WDI annual-scalar families: preserves agreed architecture.
- Proceeding to WDI Agriculture & Rural Development using the established methodology unchanged: preserves agreed architecture.
...
def run_campaign(output: Path, repository_root: Path | None = None) -> dict[str, Any]:
    snapshot = immutable_wdi_energy_mining_provenance_lineage_snapshot()
    ...
    quality_report = {
        **base,
        ...
        "energy_mining_family_maturity_assessment": snapshot["energy_mining_family_maturity"],
        ...
        "comparison_against_prior_closeouts": {"campaign7_family_maturity": "Mature", "campaign12_family_maturity": "Mature", "campaign18_family_maturity": "Mature", "provenance_lineage_closeout_pattern": "transferred unchanged"},
        "comparison_against_campaigns13_14": {"campaign16_14_energy_mining_status": "Stable before dedicated provenance-lineage closeout", "campaign18_addition": "dedicated Energy & Mining provenance-lineage completeness and family closeout"},
        ...
        "candidate_improvements_discovered": ["No implementation or architecture change is justified by Campaign 18."],
        ...
        "minimum_remaining_evidence_before_transition": "none for WDI Energy & Mining annual-scalar family entry; non-WDI multi-source disagreement remains a later falsification gap",
        "final_recommendation": "Proceed to WDI Agriculture & Rural Development annual-scalar evidence as the next Phase 2 production family using the established Production Doctrine unchanged.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Campaign 18 WDI Energy & Mining provenance-lineage closeout")
    ...
    print(json.dumps({
        ...
        "energy_mining_maturity": q["energy_mining_family_maturity_assessment"]["classification"],
