...
def pre_execution_gate(root: Path) -> dict[str, Any]:
    ...
    add("repository_count", accepted_baseline, actual=baseline, expected=[EXPECTED_REPOSITORY_COUNT, POST_PUBLICATION_REPOSITORY_COUNT, POST_EVIDENCE_PORTFOLIO_PILOT_COUNT, POST_SECOND_EVIDENCE_PORTFOLIO_COUNT, POST_NORWAY_ENERGY_PORTFOLIO_COUNT])
    add("repository_fingerprint", accepted_baseline, actual=baseline, expected=[EXPECTED_REPOSITORY_FP, POST_PUBLICATION_REPOSITORY_FP, POST_EVIDENCE_PORTFOLIO_PILOT_FP, POST_SECOND_EVIDENCE_PORTFOLIO_FP, POST_NORWAY_ENERGY_PORTFOLIO_FP])
